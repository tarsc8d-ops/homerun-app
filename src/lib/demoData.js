...
const PROS = [
  { id: 'p1', name: 'Mike Reynolds', company: 'Reynolds Plumbing Co.', category: 'plumbing', rating: 4.9, reviews: 127, hourly_rate: 85, avatar: null, bio: 'Licensed master plumber with 15 years experience. Specializing in residential repairs, water heater installation, and emergency service.', phone: '(555) 234-5678', verified: true, jobs_completed: 342 },
  { id: 'p2', name: 'Sarah Chen', company: 'BrightSpark Electric', category: 'electrical', rating: 4.8, reviews: 93, hourly_rate: 95, avatar: null, bio: 'Certified electrician handling panel upgrades, rewiring, smart home installation, and EV charger setup.', phone: '(555) 345-6789', verified: true, jobs_completed: 218 },
  { id: 'p3', name: 'James Okafor', company: 'Cool Breeze HVAC', category: 'hvac', rating: 4.7, reviews: 156, hourly_rate: 90, avatar: null, bio: 'HVAC specialist — installation, maintenance, and repair of all heating and cooling systems.', phone: '(555) 456-7890', verified: true, jobs_completed: 410 },
  { id: 'p4', name: 'Diana Morales', company: 'TopShield Roofing', category: 'roofing', rating: 4.9, reviews: 78, hourly_rate: 110, avatar: null, bio: 'Full-service roofing contractor. Shingle, tile, and metal roof installation and repair.', phone: '(555) 567-8901', verified: true, jobs_completed: 189 },
  { id: 'p5', name: 'Tom Whitfield', company: 'GreenThumb Landscapes', category: 'landscaping', rating: 4.6, reviews: 204, hourly_rate: 65, avatar: null, bio: 'Complete landscaping services — lawn care, garden design, irrigation, and seasonal clean-ups.', phone: '(555) 678-9012', verified: true, jobs_completed: 520 },
  { id: 'p6', name: 'Lisa Park', company: 'AppliancePro', category: 'appliance', rating: 4.8, reviews: 112, hourly_rate: 80, avatar: null, bio: 'Certified technician for all major appliance brands. Dishwashers, fridges, ovens, washers, and dryers.', phone: '(555) 789-0123', verified: true, jobs_completed: 295 },
  { id: 'p7', name: 'Carlos Rivera', company: 'Rivera Painting', category: 'painting', rating: 4.7, reviews: 89, hourly_rate: 70, avatar: null, bio: 'Interior and exterior painting with premium finishes. Color consultation included.', phone: '(555) 890-1234', verified: true, jobs_completed: 175 },
  { id: 'p8', name: 'Amanda Foster', company: 'CleanSweep Services', category: 'cleaning', rating: 4.9, reviews: 310, hourly_rate: 55, avatar: null, bio: 'Deep cleaning, move-in/move-out cleaning, and recurring maintenance cleaning for homes of all sizes.', phone: '(555) 901-2345', verified: true, jobs_completed: 780 },
]

const DEMO_USER = {
  id: 'demo-user',
  email: 'demo@homerun.app',
  name: 'Alex Johnson',
  avatar: null,
  role: 'homeowner',
...
const MAINTENANCE_ITEMS = [
  ...
  { id: 'm3', home_id: 'h1', category: 'roofing', title: 'Roof — Asphalt Shingles', brand: 'GAF', model: 'Timberline HDZ', install_date: '2018-04-20', last_service: '2025-04-01', next_service: '2026-04-01', status: 'attention', pro_id: 'p4', notes: 'Minor wear on south side. Inspector recommends recoating in 1-2 years.', cost_history: [{ date: '2025-04-01', amount: 250, description: 'Annual inspection' }, { date: '2018-04-20', amount: 12500, description: 'Full replacement' }] },
  { id: 'm4', home_id: 'h1', category: 'appliance', title: 'Dishwasher', brand: 'Bosch', model: '500 Series SHPM65Z55N', install_date: '2023-01-10', last_service: '2025-07-15', next_service: '2026-01-15', status: 'good', pro_id: 'p6', notes: 'Running great. Filter cleaned.', cost_history: [{ date: '2025-07-15', amount: 95, description: 'Service call' }, { date: '2023-01-10', amount: 950, description: 'Purchase + install' }] },
  { id: 'm5', home_id: 'h1', category: 'electrical', title: 'Electrical Panel', brand: 'Square D', model: 'QO 200A', install_date: '2019-06-05', last_service: '2025-06-05', next_service: '2027-06-05', status: 'good', pro_id: 'p2', notes: '200 amp panel, upgraded from 100 amp. All circuits labeled.', cost_history: [{ date: '2019-06-05', amount: 2800, description: 'Panel upgrade' }] },
...
const MESSAGES = [
  ...
  { id: 'msg4', conversation_id: 'c2', sender_id: 'p3', receiver_id: 'demo-user', text: 'Hey Alex, just confirming your AC inspection is on the books for April 25 at 10am. I\'ll check refrigerant levels and clean the coils.', timestamp: '2026-04-15T09:00:00', read: false },
]
...
const NOTIFICATIONS = [
  ...
  { id: 'n4', user_id: 'demo-user', type: 'maintenance_attention', title: 'Attention Needed', message: 'Roof at Main Residence flagged for attention — inspector recommends recoating.', timestamp: '2026-04-10T10:00:00', read: true, link: '/homes/h1' },
]
